        ...
        submenu: [{
            ...
            submenu: [{
                    ...
                    submenu: [{
                            label: 'Decimal',
                            type: 'checkbox',
                            checked: JSON.parse(window.localStorage.binToDec || false),
                            click: () => {
                                if (window.localStorage.getItem('binMode') !== "false") {
                                    window.localStorage.setItem('binMode', "false")
                                } else {
                                    window.localStorage.setItem('binMode', 'binToDec')
                                }
                            }
                        },
                        {
                            label: 'Hex',
                            type: 'checkbox',
                            checked: JSON.parse(window.localStorage.binToHex || false),
                            click: () => {
                                if (window.localStorage.getItem('binMode') !== "false") {
                                    window.localStorage.setItem('binMode', "false")
                                } else {
                                    window.localStorage.setItem('binMode', 'binToHex')
                                }
                            }
                        }
                    ]
